...
# --- Identity ---
repo: "xonaix-library"
path: "specs/standards/nodejs/STANDARDS_NODEJS.md"
unit_id: "library/standards/nodejs"
title: "Node.js Runtime Standard"
...
Node.js is used for tooling and build systems in Xonaix development.
...
CI MUST enforce linting, formatting, and security scanning for this runtime.
...
*Canonical: \`xonaix-library::specs/standards/nodejs/STANDARDS_NODEJS.md\`*
